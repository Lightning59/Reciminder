"""
Django settings for Reciminder project.
...
WSGI_APPLICATION = 'Reciminder.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases
db_mode=os.environ.get('DJANGO_DB_MODE', '')
if db_mode.lower() == "dev":
    ...
    DB_NAME=os.environ.get('DJANGO_DB', '')
